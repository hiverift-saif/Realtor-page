        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="leading-tight">
              <div className="text-xs tracking-wider uppercase" style={{ color: '#C7A76C' }}>CENTURY 21</div>
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => scrollToSection('about')} className="hidden md:inline transition bg-transparent border-0 cursor-pointer p-0" style={{ color: '#141819' }} onMouseEnter={(e) => e.currentTarget.style.color = '#C7A76C'} onMouseLeave={(e) => e.currentTarget.style.color = '#141819'}>About Me</button>
            <button onClick={() => scrollToSection('services')} className="hidden md:inline transition bg-transparent border-0 cursor-pointer p-0" style={{ color: '#141819' }} onMouseEnter={(e) => e.currentTarget.style.color = '#C7A76C'} onMouseLeave={(e) => e.currentTarget.style.color = '#141819'}>Services</button>
            <button onClick={() => scrollToSection('service-area')} className="hidden md:inline transition bg-transparent border-0 cursor-pointer p-0" style={{ color: '#141819' }} onMouseEnter={(e) => e.currentTarget.style.color = '#C7A76C'} onMouseLeave={(e) => e.currentTarget.style.color = '#141819'}>Service Areas</button>
            <button onClick={() => scrollToSection('contact')} className="hidden md:inline transition bg-transparent border-0 cursor-pointer p-0" style={{ color: '#141819' }} onMouseEnter={(e) => e.currentTarget.style.color = '#C7A76C'} onMouseLeave={(e) => e.currentTarget.style.color = '#141819'}>FAQ</button>
            <button 
              ...
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#C7A76C'}
            >
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              ...
              <div className="pt-8">
                ...
                <div className="rounded-2xl p-6 mb-8 border" style={{ backgroundColor: '#FFFFFF', borderColor: '#E6E7E8' }}>
                  <div className="mb-4">
                    <div className="text-xs tracking-wider uppercase mb-1" style={{ color: '#C7A76C' }}>CENTURY 21 Smart Realty</div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <p style={{ color: '#1C1C1C' }}>Deep knowledge of Edmonton neighborhoods and market trends</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="rounded-full p-1.5 mt-0.5" style={{ backgroundColor: '#C7A76C' }}>
                        <CheckCircle className="w-4 h-4" style={{ color: '#FFFFFF' }} />
                      </div>
                      <p style={{ color: '#1C1C1C' }}>Personalized service tailored to your unique goals</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="rounded-full p-1.5 mt-0.5" style={{ backgroundColor: '#C7A76C' }}>
                        <CheckCircle className="w-4 h-4" style={{ color: '#FFFFFF' }} />
                      </div>
                      <p style={{ color: '#1C1C1C' }}>Proven track record with 50+ satisfied clients</p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="rounded-full p-1.5 mt-0.5" style={{ backgroundColor: '#C7A76C' }}>
                        <CheckCircle className="w-4 h-4" style={{ color: '#FFFFFF' }} />
                      </div>
                      <p style={{ color: '#1C1C1C' }}>Available 7 days a week for your convenience</p>
                    </div>
                  </div>
                </div>

                <a href="tel:587-568-8591" className="inline-flex items-center gap-2 transition" style={{ color: '#C7A76C' }} onMouseEnter={(e) => e.currentTarget.style.color = '#B89960'} onMouseLeave={(e) => e.currentTarget.style.color = '#C7A76C'}>
                  ...
                  <CardContent className="p-6 md:p-8">
                    {submitted ? (
                      <div className="text-center py-12">
                        <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6" style={{ backgroundColor: 'rgba(199, 167, 108, 0.15)' }}>
                          <CheckCircle className="w-10 h-10" style={{ color: '#C7A76C' }} />
                        </div>
                        <h3 className="mb-3" style={{ color: '#141819' }}>Thank You!</h3>
                        <p className="mb-2" style={{ color: '#1C1C1C' }}>
                          I've received your consultation request and will contact you within 24 hours.
                        </p>
                        <p className="mb-6" style={{ color: '#1C1C1C' }}>
                          In the meantime, feel free to call me directly at <a href="tel:587-568-8591" className="hover:underline" style={{ color: '#C7A76C' }}>587-568-8591</a>
                        </p>
                        <Button onClick={() => setSubmitted(false)} variant="outline" style={{ borderColor: '#C7A76C', color: '#C7A76C' }}>
                      ...
                      <>
                        ...
                        <div className="mb-8">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-sm" style={{ color: '#1C1C1C' }}>{formStep === 1 ? 'Personal Info' : 'Property Details'}</span>
                          </div>
